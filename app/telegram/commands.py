...
COMMANDS: tuple[Cmd, ...] = (
    ...
    Cmd("forget", {"en": "Clear this topic's agent-saved memory (code)",
                   "ru": "Очистить память темы, сохранённую агентом (код)"},
        scope="code", help_group="settings"),  # #362: session memory is code-only
