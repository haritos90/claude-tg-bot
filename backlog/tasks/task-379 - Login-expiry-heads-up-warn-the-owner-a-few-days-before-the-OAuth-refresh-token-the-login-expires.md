...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 A localized one-line notice is shown when the login is within N days (default 3, LOGIN_EXPIRY_WARN_DAYS) of refreshTokenExpiresAt
- [x] #2 Owner-only (only they can re-login on the host) and throttled to ~once/day; shown ABOVE the answer, never inside the <tg-thinking> draft; not written to history
<!-- AC:END -->
